import svgPaths from "./svg-m33761vkon";
import img01Home from "figma:asset/36e6362e0985ed0b78c1c2e915d3ed8df2963824.png";
import { imgGroup } from "./svg-qxr2g";
    ...
    <div className="h-[16px] relative shrink-0 w-full" data-name="Heading">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <p className="font-['Red_Hat_Display:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[12px] text-white uppercase whitespace-nowrap">Core platform</p>
              ...
              <div className="overflow-clip relative size-[12px]" data-name="rh-micron-caret-right">
                <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
                    <path d={svgPaths.p10416800} fill="var(--fill-0, #A3A3A3)" id="Vector" />
                  </svg>
                </div>
              </div>
            </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-home">
        <div className="absolute inset-[4.22%_3.13%_3.12%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 14.8251">
            <path d={svgPaths.p2884b900} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-white whitespace-nowrap">Home</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-star">
        <div className="absolute inset-[6.25%_2.52%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.1948 14">
            <path d={svgPaths.p2f016100} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Favorites</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-topology">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
            <path d={svgPaths.p864ee00} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Ecosystem</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-package">
        <div className="absolute inset-[3.13%_3.13%_4.29%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 14.8141">
            <path d={svgPaths.p34d28180} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Workloads</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-network">
        <div className="absolute inset-[6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
            <path d={svgPaths.p1b70bd80} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Networking</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-storage">
        <div className="absolute inset-[3.13%_6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 15">
            <path d={svgPaths.p2d096000} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Storage</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-build">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.9994 14.9995">
            <path d={svgPaths.p5608080} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Builds</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-monitoring">
        <div className="absolute inset-[9.38%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 13">
            <path d={svgPaths.p126bcb00} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Observe</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-server">
        <div className="absolute inset-[28.13%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 7">
            <path d={svgPaths.p2845b00} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Compute</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-users">
        <div className="absolute inset-[6.25%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 14">
            <path d={svgPaths.pe92d880} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">User Management</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-settings">
        <div className="absolute inset-[3.13%_3.12%_3.13%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.9999 14.999">
            <path d={svgPaths.p17dcc480} fill="var(--fill-0, #A3A3A3)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#c7c7c7] text-[14px] whitespace-nowrap">Administration</p>
    </div>
  );
}
...
function Group25() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full">
      <div className="bg-[rgba(199,199,199,0.15)] col-1 content-stretch flex h-[40px] items-center justify-between ml-0 mt-0 px-[16px] relative rounded-[24px] row-1 w-[244px]" data-name="Menu Item">
        <Content />
      ...
      <div className="col-1 content-stretch flex h-[40px] items-center justify-between ml-0 mt-[308px] px-[16px] relative rounded-[24px] row-1 w-[244px]" data-name="Menu Item Observe">
        <Content7 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="col-1 content-stretch flex h-[40px] items-center justify-between ml-0 mt-[352px] px-[16px] relative rounded-[24px] row-1 w-[244px]" data-name="Menu Item">
        <Content8 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="col-1 content-stretch flex h-[40px] items-center justify-between ml-0 mt-[396px] px-[16px] relative rounded-[24px] row-1 w-[244px]" data-name="Menu Item">
        <Content9 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="col-1 content-stretch flex h-[40px] items-center justify-between ml-0 mt-[440px] px-[16px] relative rounded-[24px] row-1 w-[244px]" data-name="Menu Item">
        <Content10 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
...
function Frame32() {
  return (
    <div className="absolute bg-[rgba(41,41,41,0.5)] content-stretch flex flex-col gap-[24px] h-[963px] items-start left-[24px] p-[24px] rounded-[16px] top-[93px] w-[292px]">
      <div aria-hidden="true" className="absolute border border-[#383838] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Heading />
      <Group25 />
      <div className="absolute flex h-[40px] items-center justify-center left-[12px] top-[64px] w-[4px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
      ...
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="rh-ui-icon-dark-mode">
        <div className="absolute inset-[11.37%_11.38%_9.37%_9.38%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.02 19.0201">
            <path d={svgPaths.p116ee100} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[24px] top-[24px]">
      <Frame1 />
      <p className="font-['Red_Hat_Display_VF:Medium',sans-serif] font-medium leading-[36.4px] relative shrink-0 text-[28px] text-white whitespace-nowrap">Good evening</p>
    </div>
  );
}
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="rh-ui-icon-information">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.75 18.75">
            <path d={svgPaths.p258dd700} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-white whitespace-nowrap">Details</p>
    </div>
  );
}
...
function CardHeader() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Card Header">
      <Title />
      <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[4px] items-center p-[4px] relative shrink-0" data-name="Link Button">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none" />
        <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] whitespace-nowrap">View settings</p>
      </div>
    </div>
  );
}
...
function DescriptionListItem() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full" data-name="Description List Item">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal overflow-hidden relative shrink-0 text-[#c7c7c7] text-[12px] text-ellipsis w-full whitespace-nowrap">{`https://api.rhamilto.devcluster.openshift.com:6443`}</p>
    </div>
  );
}
...
function DescriptionListItem1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Description List Item">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#c7c7c7] text-[12px] w-[min-content]">03242ee9-8986-4f0f-acc0-65aad26ba6a5</p>
      <div className="content-stretch flex items-center relative shrink-0" data-name="Inline link">
        <p className="[text-decoration-skip-ink:none] decoration-solid font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] underline whitespace-nowrap">OpenShift Cluster Manager</p>
      </div>
    </div>
  );
}
...
function DescriptionListItem3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full" data-name="Description List Item">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal relative shrink-0 text-[#c7c7c7] text-[12px] w-full">4.22.0-0.ci-2026-03-02-064936</p>
    </div>
  );
}
...
function DescriptionListItem4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Description List Item">
      ...
      <div className="font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#c7c7c7] text-[14px] w-[min-content]">
        <p className="mb-0">Self-support, 60 day trial</p>
        <p>Warning alert:59 days remaining</p>
      </div>
      <div className="content-stretch flex items-center relative shrink-0" data-name="Inline link">
        <p className="[text-decoration-skip-ink:none] decoration-solid font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] underline whitespace-nowrap">Manage subscription settings</p>
      </div>
    </div>
  );
}
...
function DescriptionListItem5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full" data-name="Description List Item">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal relative shrink-0 text-[#c7c7c7] text-[12px] w-full">stable-4.22</p>
    </div>
  );
}
...
function Card() {
  return (
    <div className="backdrop-blur-[6.25px] bg-[rgba(41,41,41,0.5)] relative rounded-[16px] shrink-0 w-full" data-name="Card">
      <div aria-hidden="true" className="absolute border border-[#383838] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_6px_0px_rgba(0,0,0,0.5)]" />
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="rh-ui-icon-server-stack">
        <div className="absolute inset-[3.13%_6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.5 18.75">
            <path d={svgPaths.p1ef87c00} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-white whitespace-nowrap">Cluster inventory</p>
    </div>
  );
}
...
function Frame49() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <Frame78 />
      <div className="bg-[#4d4d4d] content-stretch flex items-center justify-center min-w-[32px] px-[8px] relative rounded-[999px] shrink-0 w-[32px]" data-name="Badge">
        ...
        <p className="flex-[1_0_0] font-['Red_Hat_Text_VF:Medium',sans-serif] font-medium leading-[18px] min-h-px min-w-px relative text-[12px] text-center text-white">6</p>
      </div>
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <Frame77 />
      <div className="bg-[#4d4d4d] content-stretch flex items-center justify-center min-w-[32px] px-[8px] relative rounded-[999px] shrink-0 w-[38px]" data-name="Badge">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none rounded-[999px]" />
        <p className="flex-[1_0_0] font-['Red_Hat_Text_VF:Medium',sans-serif] font-medium leading-[18px] min-h-px min-w-px relative text-[12px] text-center text-white">273</p>
      </div>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      ...
      <div className="bg-[#4d4d4d] content-stretch flex items-center justify-center min-w-[32px] px-[8px] relative rounded-[999px] shrink-0 w-[32px]" data-name="Badge">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none rounded-[999px]" />
        <p className="flex-[1_0_0] font-['Red_Hat_Text_VF:Medium',sans-serif] font-medium leading-[18px] min-h-px min-w-px relative text-[12px] text-center text-white">2</p>
      </div>
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      ...
      <div className="bg-[#4d4d4d] content-stretch flex items-center justify-center min-w-[32px] px-[8px] relative rounded-[999px] shrink-0 w-[32px]" data-name="Badge">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none rounded-[999px]" />
        <p className="flex-[1_0_0] font-['Red_Hat_Text_VF:Medium',sans-serif] font-medium leading-[18px] min-h-px min-w-px relative text-[12px] text-center text-white">0</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex h-px items-start relative shrink-0 w-full" data-name="Divider">
        <div className="bg-[#a3a3a3] flex-[1_0_0] h-px min-h-px min-w-px" />
      </div>
      <Frame52 />
      <div className="content-stretch flex h-px items-start relative shrink-0 w-full" data-name="Divider">
        <div className="bg-[#a3a3a3] flex-[1_0_0] h-px min-h-px min-w-px" />
...
function Frame54() {
  return (
    <div className="backdrop-blur-[6.25px] bg-[rgba(41,41,41,0.5)] relative rounded-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#383838] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_6px_0px_rgba(0,0,0,0.5)]" />
      <div className="content-stretch flex flex-col gap-[24px] items-start p-[24px] relative w-full">
        <Title1 />
        <Frame53 />
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="rh-ui-icon-history">
        <div className="absolute inset-[3.13%_3.13%_3.12%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.75 18.7501">
            <path d={svgPaths.p1af00480} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-white whitespace-nowrap">Activity</p>
    </div>
  );
}
...
function Title2() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Title">
      ...
      <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[4px] items-center p-[4px] relative shrink-0" data-name="Link Button">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none" />
        <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] whitespace-nowrap">View all events</p>
      </div>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      ...
      <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[4px] items-center p-[4px] relative shrink-0" data-name="Link Button">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none" />
        <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] whitespace-nowrap">Pause</p>
      </div>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="absolute backdrop-blur-[6.25px] bg-[rgba(41,41,41,0.5)] bottom-[2.89%] left-3/4 right-[1.54%] rounded-[16px] top-[10.74%]">
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Title">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="rh-ui-icon-in-progress">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.75 18.75">
            <path d={svgPaths.p240a9f00} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-white whitespace-nowrap">Status</p>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      ...
      <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[4px] items-center p-[4px] relative shrink-0" data-name="Link Button">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none" />
        <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] whitespace-nowrap">View alerts</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Status Item">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-check-circle-fill">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
            <path d={svgPaths.p31309b40} fill="var(--fill-0, #87BB62)" id="Vector" />
          </svg>
        </div>
      </div>
...
function Frame39() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-white whitespace-nowrap">CannotRetrieveUpdates</p>
      <div className="content-stretch flex items-center relative shrink-0" data-name="Inline link">
        <p className="[text-decoration-skip-ink:none] decoration-solid font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] underline whitespace-nowrap">View details</p>
      </div>
    </div>
  );
}
...
function Frame109() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <Frame39 />
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7c7c7] text-[12px] w-full">Mar 3, 2026, 10:37 AM</p>
    </div>
  );
}
...
function Frame108() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative">
      <Frame109 />
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[1.5] overflow-hidden relative shrink-0 text-[#c7c7c7] text-[14px] text-ellipsis w-full">{`Failure to retrieve updates means that cluster administrators will need to monitor for available updates on their own or risk falling behind on security or other bugfixes. If the failure is expected, you can clear spec.channel in the ClusterVersion object to tell the cluster-version operator to not retrieve updates. Failure reason VersionNotFound . For more information refer to \`oc get clusterversion/version -o=jsonpath="{.status.conditions[?(.type=='RetrievedUpdates')]}{'\n'}"\` or`}</p>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[14px] text-white whitespace-nowrap">AlertmanagerReceiversNotConfigured</p>
      <div className="content-stretch flex items-center relative shrink-0" data-name="Inline link">
        <p className="[text-decoration-skip-ink:none] decoration-solid font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#b9dafc] text-[14px] underline whitespace-nowrap">Configure</p>
      </div>
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <Frame42 />
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7c7c7] text-[12px] w-full">Mar 3, 2026, 10:36 AM</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[16px] h-[21px] items-center relative shrink-0 w-[162px]" data-name="Title">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="rh-ui-icon-speedometer">
        <div className="absolute inset-[3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.75 18.75">
            <path d={svgPaths.p9139970} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-white whitespace-nowrap">Cluster utilization</p>
    </div>
  );
}
...
function ToggleContent() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Toggle content">
      <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[14px] text-white whitespace-nowrap">Filter by Node type</p>
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[21px]" data-name="(🚫 don't change!) Caret dropdown">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.5px)] size-[14px] top-[calc(50%+0.5px)]" data-name="🖼️ Icon">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.16622 4.66654">
            <path d={svgPaths.p1f0ce200} fill="var(--fill-0, #F2F2F2)" id="ð¼ï¸ Icon" />
          </svg>
        </div>
      </div>
    </div>
...
function ToggleContent1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Toggle content">
      <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[14px] text-white whitespace-nowrap">1 hour</p>
    </div>
  );
}
...
function Frame116() {
  return (
    <div className="content-stretch flex font-['Red_Hat_Mono:Regular',sans-serif] gap-[62px] items-center justify-end relative shrink-0 text-[#c7c7c7] text-[12px] w-[342px] whitespace-nowrap">
...
function Frame118() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px relative">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal relative shrink-0 text-[#c7c7c7] text-[12px] w-full">21.76 cores / 24 cores</p>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents inset-[53.73%_0_23.41%_14.91%]" data-name="Group">
      ...
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal inset-[53.73%_82.75%_23.41%_14.91%] leading-[normal] text-[#c7c7c7] text-[12px] whitespace-nowrap">5</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents inset-[20.36%_0_56.79%_12.87%]" data-name="Group">
      ...
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal inset-[20.36%_82.75%_56.79%_12.87%] leading-[normal] text-[#c7c7c7] text-[12px] whitespace-nowrap">10</p>
    </div>
  );
}
...
function Frame117() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full">
      <Frame118 />
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7c7c7] text-[12px] whitespace-nowrap">2.24</p>
      <Cpu />
    </div>
  );
}
...
function Frame120() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px relative">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal relative shrink-0 text-[#c7c7c7] text-[12px] w-full">62.32 GiB / 92.12 GiB</p>
    </div>
  );
}
...
function Group9() {
  return (
    <div className="absolute contents inset-[56.87%_0_20.27%_4.39%]" data-name="Group">
      ...
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal inset-[56.87%_82.75%_20.27%_4.39%] leading-[normal] text-[#c7c7c7] text-[12px] whitespace-nowrap">20 GiB</p>
    </div>
  );
}
...
function Group10() {
  return (
    <div className="absolute contents inset-[26.64%_0_50.5%_4.39%]" data-name="Group">
      ...
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal inset-[26.64%_82.75%_50.5%_4.39%] leading-[normal] text-[#c7c7c7] text-[12px] whitespace-nowrap">40 GiB</p>
    </div>
  );
}
...
function Frame119() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full">
      <Frame120 />
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7c7c7] text-[12px] whitespace-nowrap">29.79 GiB</p>
      <Memory />
    </div>
  );
}
...
function Frame122() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px relative">
      ...
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal relative shrink-0 text-[#c7c7c7] text-[12px] w-full">610 GiB / 718.7 GiB</p>
    </div>
  );
}
...
function Group16() {
  return (
    <div className="absolute contents inset-[36.08%_0_41.06%_2.34%]" data-name="Group">
      ...
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal inset-[36.08%_82.75%_41.06%_2.34%] leading-[normal] text-[#c7c7c7] text-[12px] whitespace-nowrap">100 GiB</p>
    </div>
  );
}
...
function Frame121() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full">
      <Frame122 />
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7c7c7] text-[12px] whitespace-nowrap">108.6 GiB</p>
      <File />
    </div>
  );
}
...
function Group20() {
  return (
    <div className="absolute contents inset-[23.16%_0_53.98%_2.92%]" data-name="Group">
      ...
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal inset-[23.16%_84.21%_53.98%_2.92%] leading-[normal] text-[#c7c7c7] text-[12px] whitespace-nowrap">5 MBps</p>
    </div>
  );
}
...
function Frame123() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full">
      <Frame124 />
      <div className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#c7c7c7] text-[12px] whitespace-nowrap">
      ...
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="rh-ui-icon-menu-bars">
        <div className="absolute inset-[15.63%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.5 16.5">
            <path d={svgPaths.p28fa3580} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          </svg>
        </div>
      </div>
  ...
  return (
    <div className="absolute inset-[3.91%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.75 14.75">
        <g id="Group">
          <path d={svgPaths.p1388cf00} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          <path d={svgPaths.p33d09900} fill="var(--fill-0, #F2F2F2)" id="Vector_2" />
          <path d={svgPaths.p2e5b1680} fill="var(--fill-0, #F2F2F2)" id="Vector_3" />
          <path d={svgPaths.p38df6f80} fill="var(--fill-0, #F2F2F2)" id="Vector_4" />
          <path d={svgPaths.p2e0e5700} fill="var(--fill-0, #F2F2F2)" id="Vector_5" />
          <path d={svgPaths.p385e8600} fill="var(--fill-0, #F2F2F2)" id="Vector_6" />
          <path d={svgPaths.p9155f00} fill="var(--fill-0, #F2F2F2)" id="Vector_7" />
          <path d={svgPaths.p36882e80} fill="var(--fill-0, #F2F2F2)" id="Vector_8" />
          <path d={svgPaths.p14445380} fill="var(--fill-0, #F2F2F2)" id="Vector_9" />
        </g>
      </svg>
    </div>
  );
...
function UiIcon1() {
  return (
    <div className="absolute contents inset-0" data-name="UI icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Group">
          <path d={svgPaths.p2238de70} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          <path d={svgPaths.p228cba80} fill="var(--fill-0, #F2F2F2)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function UiIcon2() {
  return (
    <div className="absolute contents inset-0" data-name="UI icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Group">
          <path d={svgPaths.p14c76000} fill="var(--fill-0, #F2F2F2)" id="Vector" />
          <path d={svgPaths.p228cba80} fill="var(--fill-0, #F2F2F2)" id="Vector_2" />
          <path d={svgPaths.pfe94800} fill="var(--fill-0, #F2F2F2)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function Frame33() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <Apps />
      <div className="bg-[rgba(21,21,21,0.8)] content-stretch flex gap-[4px] h-[37px] items-center justify-center min-w-[40px] p-[8px] relative rounded-[6px] shrink-0 w-[60px]" data-name="Overflow menu">
        <div aria-hidden="true" className="absolute border border-[#a3a3a3] border-solid inset-0 pointer-events-none rounded-[6px]" />
        <div className="h-[21px] relative shrink-0 w-[16px]" data-name="IconWrapper">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+1.17px)] size-[14px] top-[calc(50%+0.5px)]" data-name="🖼️ Icon">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.1562 13.125">
              <path d={svgPaths.p1567aa00} fill="var(--fill-0, #F2F2F2)" id="ð¼ï¸ Icon" />
            </svg>
          </div>
        </div>
        <p className="flex-[1_0_0] font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] min-h-px min-w-px relative text-[14px] text-center text-white">10</p>
      </div>
      <Add />
        ...
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-ai-experience">
          <div className="absolute inset-[4.67%_4.68%_3.13%_3.11%]" data-name="icon">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.7534 14.7519">
              <path d={svgPaths.p36bc1600} fill="var(--fill-0, #F2F2F2)" id="icon" />
            </svg>
          </div>
        </div>
      </div>
...
function AvatarMd() {
  return (
    <div className="bg-[#92c5f9] content-stretch flex items-center justify-center p-[4px] relative rounded-[999px] shrink-0 size-[36px]" data-name="avatar-MD">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#1f1f1f] text-[14px] text-center whitespace-nowrap">JS</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="absolute bg-[rgba(41,41,41,0.5)] content-stretch flex h-[69px] items-center justify-between left-0 px-[32px] py-[16px] top-0 w-[1920px]">
      <div aria-hidden="true" className="absolute border-[#383838] border-b border-solid inset-0 pointer-events-none shadow-[0px_1px_4px_0px_rgba(0,0,0,0.5)]" />
      <Frame31 />
      <Frame127 />
    </div>
  );
...
export default function Component01Home() {
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="01 - Home">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[32px] size-full" src={img01Home} />
      <Frame32 />
      <div className="absolute h-[963px] left-[calc(16.67%+20px)] overflow-clip top-[93px] w-[1556px]" data-name="Home Content">
        <div className="absolute backdrop-blur-[6.25px] bg-[rgba(41,41,41,0.5)] border border-[#383838] border-solid inset-0 rounded-[16px] shadow-[0px_1px_6px_0px_rgba(0,0,0,0.5)]" data-name="Main Surface" />
        <Frame />
        <Frame74 />
        <Frame55 />
        <Frame107 />
