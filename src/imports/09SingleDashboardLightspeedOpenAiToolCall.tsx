import svgPaths from "./svg-baqp8zfmx6";
import img09SingleDashboardLightspeedOpenAiToolCall from "figma:asset/0063c8b2c924b83b2301cb4476c9f3da3f438e88.png";
...
function Frame10() {
  return (
    <div className="content-stretch flex font-['Red_Hat_Mono:SemiBold',sans-serif] font-semibold items-center leading-[18px] relative shrink-0 text-[#4d4d4d] text-[12px] whitespace-nowrap">
      <p className="relative shrink-0">{`Searching for metrics in 'test-lab-alpha'`}</p>
      <p className="relative shrink-0">...</p>
    </div>
  );
}

function HitlToolStatus() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="HITL Tool Status">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Animated Spinner">
        <div className="relative shrink-0 size-[16px]" data-name="Spinner">
          <div className="absolute inset-[-3.13%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
              <path d={svgPaths.p20977ca0} id="Ellipse 1" stroke="var(--stroke-0, #0066CC)" strokeLinecap="round" />
            </svg>
          </div>
        </div>
      </div>
...
export default function Component09SingleDashboardLightspeedOpenAiToolCall() {
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="09 - Single Dashboard - Lightspeed Open - AI Tool Call">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[32px] size-full" src={img09SingleDashboardLightspeedOpenAiToolCall} />
      <Chatbot />
