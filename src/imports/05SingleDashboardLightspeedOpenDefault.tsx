import svgPaths from "./svg-811xow1zm8";
import img05SingleDashboardLightspeedOpenDefault from "figma:asset/0063c8b2c924b83b2301cb4476c9f3da3f438e88.png";
...
import { imgGroup, imgGroup1, imgGroup2, imgGroup3, imgGroup4 } from "./svg-j82n9";
...
function Group26() {
  return (
    <div className="absolute inset-[0_27.27%_48.83%_22.92%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-30.219px_49.335px] mask-size-[40.407px_23.218px]" data-name="Group" style={{ maskImage: `url('${imgGroup1}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 106.091 65.5013">
        <g id="Group">
          <path d={svgPaths.p1ed4e300} fill="var(--fill-0, #2E2E2E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup7() {
  return (
    <div className="absolute contents inset-[38.54%_72.3%_43.32%_8.73%]" data-name="Clip path group">
      <Group26 />
    </div>
  );
}
...
function Group25() {
  return (
    <div className="absolute contents inset-[38.54%_72.3%_43.32%_8.73%]" data-name="Group">
      <div className="absolute inset-[38.54%_72.3%_43.32%_8.73%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
          <path d={svgPaths.p29e87800} fill="var(--fill-0, #4D4D4D)" id="Vector" />
        </svg>
      </div>
      <ClipPathGroup7 />
    </div>
...
function Group27() {
  return (
    <div className="absolute inset-[48.69%_17.16%_0_33.03%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[64.366px_8.298px] mask-size-[40.407px_23.218px]" data-name="Group" style={{ maskImage: `url('${imgGroup2}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 106.098 65.6759">
        <g id="Group">
          <path d={svgPaths.p39f44c80} fill="var(--fill-0, #2E2E2E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup8() {
  return (
    <div className="absolute contents inset-[55.17%_17.78%_26.69%_63.24%]" data-name="Clip path group">
      <Group27 />
    </div>
  );
}
...
function Group24() {
  return (
    <div className="absolute contents inset-[0_15.14%_0_8.73%]" data-name="Group">
      <div className="absolute inset-[55.17%_17.78%_26.69%_63.24%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
          <path d={svgPaths.p123d0200} fill="var(--fill-0, #4D4D4D)" id="Vector" />
        </svg>
      </div>
      <Group25 />
      <div className="absolute inset-[0_25.28%_48.83%_24.91%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 106.091 65.5013">
          <path d={svgPaths.p14c29000} fill="var(--fill-0, #EE0000)" id="Vector" />
        </svg>
      </div>
      <ClipPathGroup8 />
      <div className="absolute inset-[48.69%_15.14%_0_35.05%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 106.098 65.6759">
          <path d={svgPaths.p39f44c80} fill="var(--fill-0, #EE0000)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Group29() {
  return (
    <div className="absolute inset-[56.78%_57.85%_25.08%_23.18%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-8.396px_8.784px] mask-size-[40.407px_23.218px]" data-name="Group" style={{ maskImage: `url('${imgGroup3}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
        <g id="Group">
          <path d={svgPaths.p29e87800} fill="var(--fill-0, #C9C9C9)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup9() {
  return (
    <div className="absolute contents inset-[63.65%_61.79%_18.22%_19.24%]" data-name="Clip path group">
      <Group29 />
    </div>
  );
}
...
function Group28() {
  return (
    <div className="absolute contents inset-[52.8%_56.4%_18.22%_19.24%]" data-name="Group">
      <div className="absolute inset-[63.65%_61.79%_18.22%_19.24%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
          <path d={svgPaths.p29e87800} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[63.65%_61.79%_18.22%_19.24%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
      ...
      <ClipPathGroup9 />
      <div className="absolute inset-[52.8%_56.4%_29.06%_24.63%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
          <path d={svgPaths.p17de2870} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Group31() {
  return (
    <div className="absolute inset-[21.49%_11.26%_60.37%_69.77%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-8.395px_8.785px] mask-size-[40.407px_23.218px]" data-name="Group" style={{ maskImage: `url('${imgGroup4}')` }}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
        <g id="Group">
          <path d={svgPaths.p1da4d100} fill="var(--fill-0, #C9C9C9)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ClipPathGroup10() {
  return (
    <div className="absolute contents inset-[28.35%_15.2%_53.51%_65.83%]" data-name="Clip path group">
      <Group31 />
    </div>
  );
}
...
function Group30() {
  return (
    <div className="absolute contents inset-[17.5%_9.81%_53.51%_65.83%]" data-name="Group">
      <div className="absolute inset-[28.35%_15.2%_53.51%_65.83%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
          <path d={svgPaths.p14138bb0} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[28.35%_15.2%_53.51%_65.83%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
      ...
      <ClipPathGroup10 />
      <div className="absolute inset-[17.5%_9.81%_64.36%_71.22%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.4073 23.2176">
          <path d={svgPaths.p3beeb200} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Artwork() {
  return (
    <div className="h-[128px] relative shadow-[0px_2px_64px_0px_rgba(0,0,0,0.75)] shrink-0 w-[213px]" data-name="Artwork">
      <Group24 />
      <Group28 />
      <div className="absolute inset-[65.58%_85.21%_21.2%_0]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.4954 16.9272">
          <path d={svgPaths.p247d0100} fill="var(--fill-0, #4D4D4D)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[29.43%_0_57.35%_85.21%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.4954 16.9273">
          <path d={svgPaths.p2441bc00} fill="var(--fill-0, #4D4D4D)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[81.81%_84.32%_12.02%_10.21%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6541 7.89015">
          <path d={svgPaths.p1a637180} fill="var(--fill-0, #C9C9C9)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[45.66%_36.89%_48.17%_57.64%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6541 7.89015">
          <path d={svgPaths.p1b2e2580} fill="var(--fill-0, #C9C9C9)" id="Vector" />
        </svg>
      </div>
      <Group30 />
      <div className="absolute inset-[83.02%_69.86%_2.02%_15.48%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.2147 19.1451">
          <path d={svgPaths.p28d70380} fill="var(--fill-0, #2E2E2E)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[23.89%_31.71%_61.15%_53.64%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.2147 19.1451">
          <path d={svgPaths.pec11b80} fill="var(--fill-0, #2E2E2E)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Frame40() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-ai-experience-fill">
        <div className="absolute inset-[4.67%_4.68%_3.13%_3.13%]" data-name="icon">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.7505 14.7519">
            <path d={svgPaths.p435fc00} fill="var(--fill-0, #1F1F1F)" id="icon" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[1.5] relative shrink-0 text-[#151515] text-[18px] whitespace-nowrap">Hi John</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0" data-name="Heading">
      <Frame40 />
      <p className="font-['Red_Hat_Display_VF:Bold',sans-serif] font-bold leading-[31.2px] relative shrink-0 text-[#151515] text-[24px] whitespace-nowrap">Where should we start?</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[rgba(199,199,199,0.25)] relative rounded-[999px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Show CPU and memory for the last 6 hours</p>
        </div>
      </div>
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-[rgba(199,199,199,0.25)] relative rounded-[999px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Identify pods hitting resource limits</p>
        </div>
      </div>
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[rgba(199,199,199,0.25)] relative rounded-[999px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center px-[24px] py-[8px] relative w-full">
          <p className="font-['Red_Hat_Text_VF:Regular',sans-serif] font-normal leading-[21px] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Build a Golden Signals dashboard</p>
        </div>
      </div>
    </div>
  );
...
function Suggestions() {
  return (
    <div className="mix-blend-luminosity relative shrink-0 w-full" data-name="Suggestions">
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Chatbot Main">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start px-[24px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[48px] items-center justify-center min-h-px min-w-px relative w-full" data-name="Welcome">
            <Artwork />
            <Heading />
            <Suggestions />
          </div>
...
function ChatbotHeader() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[24px] items-center left-1/2 px-[24px] py-[16px] rounded-tl-[16px] rounded-tr-[16px] top-0 w-[450px]" data-name="Chatbot Header">
      <HeaderActions />
      <Brand />
      <HeaderActions1 />
    </div>
...
function ChatbotFooter() {
  return (
    <div className="-translate-x-1/2 absolute backdrop-blur-[2px] bottom-0 content-stretch flex flex-col gap-[16px] items-start left-1/2 pb-[16px] pt-[24px] px-[24px] rounded-bl-[16px] rounded-br-[16px] w-[450px]" data-name="Chatbot Footer">
      <InputContainer />
      <Footnote />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <div className="relative shrink-0 size-[18px]" data-name="IconWrapper">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+1.92px)] size-[12px] top-[calc(50%-0.25px)]" data-name="🖼️ Icon">
...
export default function Component05SingleDashboardLightspeedOpenDefault() {
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="05 - Single Dashboard - Lightspeed Open - Default">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[32px] size-full" src={img05SingleDashboardLightspeedOpenDefault} />
