import svgPaths from "./svg-r0wqjmqxdf";
import img04SingleDashboard from "figma:asset/0063c8b2c924b83b2301cb4476c9f3da3f438e88.png";
...
import { imgGroup, imgGroup1, imgGroup2, imgGroup3, imgGroup4 } from "./svg-h1az9";
...
function ChatbotRegions() {
  return (
    <div className="absolute content-stretch flex flex-col h-[968px] items-start left-full rounded-[16px] top-[88px] w-[450px]" data-name="Chatbot Regions">
      <ChatbotHeader />
      <ChatbotMain />
      <ChatbotFooter />
    </div>
...
function Chatbot() {
  return (
    <div className="absolute contents left-full top-[88px]" data-name="Chatbot">
      <div className="absolute bg-[rgba(41,41,41,0.2)] bottom-[2.22%] left-full right-[-23.44%] rounded-[32px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.16)] top-[8.15%]" data-name="Chatbot Background" />
      <ChatbotRegions />
    </div>
  );
}
...
function DropdownCaretValidation4() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip relative shrink-0" data-name="Dropdown Caret & Validation">
      <div className="relative shrink-0 size-[21px]" data-name="(🚫 don't change!) Caret dropdown">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+3.42px)] size-[14px] top-[calc(50%+5.17px)]" data-name="🖼️ Icon">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.16619 4.66654">
            <path d={svgPaths.p1436a2c0} fill="var(--fill-0, #1F1F1F)" id="ð¼ï¸ Icon" />
          </svg>
        </div>
...
export default function Component04SingleDashboard() {
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="04 - Single Dashboard">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[32px] size-full" src={img04SingleDashboard} />
      <div className="absolute h-[968px] left-[calc(16.67%+20px)] opacity-0 top-[96px] w-[1556px]" data-name="Dashboards Content">
        <div className="absolute bg-[rgba(41,41,41,0.2)] inset-0 rounded-[32px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.16)]" data-name="Main Surface" />
        <Frame98 />
      ...
      <Chatbot />
      <Frame40 />
      <div className="absolute backdrop-blur-[0px] bg-white h-[968px] left-[calc(16.67%+20px)] rounded-[16px] top-[88px] w-[1556px]" data-name="Dashboard Single Content">
