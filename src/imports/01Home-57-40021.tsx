import svgPaths from "./svg-uyl1qbaoei";
import img01Home from "figma:asset/0063c8b2c924b83b2301cb4476c9f3da3f438e88.png";
import { imgGroup } from "./svg-84c61";
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-home">
        <div className="absolute inset-[4.22%_3.13%_3.12%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 14.8251">
            <path d={svgPaths.p2884b900} fill="var(--fill-0, #1F1F1F)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Home</p>
    </div>
  );
}
...
function Group25() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full">
      <div className="bg-[rgba(199,199,199,0.25)] col-1 content-stretch flex h-[40px] items-center justify-between ml-0 mt-0 px-[16px] relative rounded-[24px] row-1 w-[244px]" data-name="Menu Item">
        <Content />
...
function Frame32() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.5)] content-stretch flex flex-col gap-[24px] h-[963px] items-start left-[24px] p-[24px] rounded-[16px] top-[93px] w-[292px]">
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-center p-[16px] relative rounded-[16px] shrink-0 size-[48px]">
      <div aria-hidden="true" className="absolute bg-white inset-0 mix-blend-luminosity pointer-events-none rounded-[16px]" />
...
function Card() {
  return (
    <div className="backdrop-blur-[6.25px] bg-[rgba(255,255,255,0.8)] relative rounded-[16px] shrink-0 w-full" data-name="Card">
...
function Frame54() {
  return (
    <div className="backdrop-blur-[6.25px] bg-[rgba(255,255,255,0.8)] relative rounded-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_6px_0px_rgba(41,41,41,0.15)]" />
      <div className="content-stretch flex flex-col gap-[24px] items-start p-[24px] relative w-full">
        <Title1 />
        <Frame53 />
...
function Frame55() {
  return (
    <div className="absolute backdrop-blur-[6.25px] bg-[rgba(255,255,255,0.8)] bottom-[2.89%] left-3/4 right-[1.54%] rounded-[16px] top-[10.74%]">
...
function Frame33() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <Apps />
      <div className="bg-[rgba(255,255,255,0.8)] content-stretch flex gap-[4px] h-[37px] items-center justify-center min-w-[40px] p-[8px] relative rounded-[6px] shrink-0 w-[60px]" data-name="Overflow menu">
        ...
        <div className="h-[21px] relative shrink-0 w-[16px]" data-name="IconWrapper">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+1.17px)] size-[14px] top-[calc(50%+0.5px)]" data-name="🖼️ Icon">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.1562 13.125">
              <path d={svgPaths.p1567aa00} fill="var(--fill-0, #1F1F1F)" id="ð¼ï¸ Icon" />
            </svg>
          </div>
        </div>
...
function Frame30() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.5)] content-stretch flex h-[69px] items-center justify-between left-0 px-[32px] py-[16px] top-0 w-[1920px]">
  ...
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="01 - Home">
      ...
      <div className="absolute h-[963px] left-[calc(16.67%+20px)] overflow-clip top-[93px] w-[1556px]" data-name="Home Content">
        <div className="absolute backdrop-blur-[6.25px] bg-[rgba(255,255,255,0.5)] border border-[#e0e0e0] border-solid inset-0 rounded-[16px] shadow-[0px_1px_6px_0px_rgba(41,41,41,0.15)]" data-name="Main Surface" />
        <Frame />
        <Frame74 />
        <Frame55 />
        <Frame107 />
