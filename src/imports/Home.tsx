import svgPaths from "./svg-929lpcd05l";
import { imgGroup } from "./svg-0mrfg";
  ...
  return (
    <div className="absolute inset-[0_6.25%_-0.03%_6.25%]" data-name="UI icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 16.005">
        <g id="UI icon">
          <path d={svgPaths.p31ff3ea0} fill="var(--fill-0, #1F1F1F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Notifications() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0 size-[40px]" data-name="Notifications">
...
function AvatarMd() {
  return (
    <div className="bg-[#b9dafc] content-stretch flex items-center justify-center p-[4px] relative rounded-[999px] shrink-0 size-[40px]" data-name="avatar-MD">
...
function Heading() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[24px] px-[16px] top-[112px] w-[292px]" data-name="Heading">
...
function Content7() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Content">
      ...
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#4d4d4d] text-[14px] whitespace-nowrap">Observe</p>
    </div>
  );
}
...
function DescriptionListItem() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full" data-name="Description List Item">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] text-[14px] w-full">Cluster API address</p>
...
function DescriptionListItem1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Description List Item">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[#151515] text-[14px] w-[min-content]">Cluster ID</p>
...
function DescriptionListItem2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Description List Item">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[#151515] text-[14px] w-[min-content]">Infrastructure provider</p>
...
function DescriptionListItem3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full" data-name="Description List Item">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] text-[14px] w-full">OpenShift version</p>
...
function DescriptionListItem4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Description List Item">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[#151515] text-[14px] w-[min-content]">Service Level Agreement (SLA)</p>
...
function DescriptionListItem5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] relative shrink-0 w-full" data-name="Description List Item">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] text-[14px] w-full">Update channel</p>
...
function Card() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] relative rounded-[24px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.08)] shrink-0 w-full" data-name="Card">
...
function Frame75() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <Frame2 />
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Nodes</p>
    </div>
  );
}
...
function Frame74() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <Frame3 />
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Pods</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <Frame4 />
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">StorageClasses</p>
    </div>
  );
}
...
function Frame72() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <Frame5 />
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">PersistentVolumeClaims</p>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] relative rounded-[24px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.08)] shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[24px] items-start p-[24px] relative w-full">
        <Title1 />
        <Frame50 />
      </div>
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] relative shrink-0 text-[14px] w-full">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] w-full">Ongoing</p>
      <p className="font-['Red_Hat_Text:Regular',sans-serif] font-normal relative shrink-0 text-[#4d4d4d] w-full">There are no ongoing activities.</p>
    </div>
  );
}
...
function Frame40() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Recent events</p>
      <div className="bg-[rgba(255,255,255,0)] content-stretch flex gap-[4px] items-center p-[4px] relative shrink-0" data-name="Link Button">
        <div aria-hidden="true" className="absolute border-0 border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none" />
...
function Frame43() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame6 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">{`Pulling image "nginx"`}</p>
    </div>
  );
}
...
function Frame44() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">12:52 PM</p>
      <Frame43 />
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame7 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Back-off restarting failed container task-pv-container in pod task-pv-pod_robb(295e1f3c-bea0-42b7-b557-ce829dc542b6)</p>
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">12:40 PM</p>
      <Frame54 />
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame8 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Job completed</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">12:14 PM</p>
      <Frame56 />
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame9 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Saw completed job: image-pruner-29543040, condition: Complete</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">11:53 PM</p>
      <Frame58 />
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame10 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Created container: image-pruner</p>
    </div>
  );
}
...
function Frame59() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">11:38 PM</p>
      <Frame60 />
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame11 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Add eth0 [10.128.2.28/23] from ovn-kubernetes</p>
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">11:03 PM</p>
      <Frame62 />
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame12 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Created pod: image-pruner-29543040-cd4vd</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">10:11 PM</p>
      <Frame64 />
    </div>
  );
}
...
function Frame66() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame13 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Started container image-pruner</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">10:59 PM</p>
      <Frame66 />
    </div>
  );
}
...
function Frame68() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame14 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">{`Container image "registry.ci.openshift.org/ocp/4.22-2026-03-02-064936@sha256:90d1438ef55d33eb710df14baa14206c204718c931735dc099d098b1dc33ca90" already present on machine`}</p>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">10:52 PM</p>
      <Frame68 />
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame15 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Created job image-pruner-29543040</p>
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">9:49 PM</p>
      <Frame70 />
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame16 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Successfully assigned openshift-image-registry/image-pruner-29543040-cd4vd to ip-10-0-8-40.ec2.internal</p>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">9:48 PM</p>
      <Frame77 />
    </div>
  );
}
...
function Frame78() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">9:43 PM</p>
      <Frame79 />
    </div>
  );
}
...
function Frame81() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame18 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Started container insights-gathering</p>
    </div>
  );
}
...
function Frame80() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">9:39 PM</p>
      <Frame81 />
    </div>
  );
}
...
function Frame83() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame19 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Created container: insights-gathering</p>
    </div>
  );
}
...
function Frame82() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">9:33 PM</p>
      <Frame83 />
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame20 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Created pod: periodic-gathering-5xsjm-vbfbg</p>
    </div>
  );
}
...
function Frame84() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">8:17 PM</p>
      <Frame85 />
    </div>
  );
}
...
function Frame86() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">8:02 PM</p>
      <Frame87 />
    </div>
  );
}
...
function Frame89() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame22 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Add eth0 [10.131.0.37/23] from ovn-kubernetes</p>
    </div>
  );
}
...
function Frame88() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">7:45 PM</p>
      <Frame89 />
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame23 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">Successfully assigned openshift-insights/periodic-gathering-5xsjm-vbfbg to ip-10-0-66-225.ec2.internal</p>
    </div>
  );
}
...
function Frame90() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[12px] text-right w-[58px]">7:36 PM</p>
      <Frame91 />
    </div>
  );
}
...
function Frame93() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px relative">
      <Frame24 />
      <p className="flex-[1_0_0] font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px overflow-hidden relative text-[#151515] text-[14px] text-ellipsis whitespace-nowrap">{`(combined from similar events): Successfully pulled image "nginx" in 303ms (303ms including waiting). Image size: 164487518 bytes`}</p>
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.5)] bottom-[2.89%] content-stretch flex flex-col gap-[24px] items-start left-3/4 overflow-clip p-[24px] right-[1.54%] rounded-[24px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.08)] top-[10.74%]">
      <Title2 />
      <Frame42 />
      <div className="content-stretch flex h-px items-start opacity-25 relative shrink-0 w-full" data-name="Divider">
        <div className="bg-[#c7c7c7] flex-[1_0_0] h-px min-h-px min-w-px" />
...
function StatusItem() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Status Item">
      ...
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Cluster</p>
    </div>
  );
}
...
function StatusItem1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Status Item">
      ...
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Control Plane</p>
    </div>
  );
}
...
function StatusItem2() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Status Item">
      ...
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Operators</p>
    </div>
  );
}
...
function StatusItem3() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Status Item">
      ...
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Dynamic Plugins</p>
    </div>
  );
}
...
function StatusItem4() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Status Item">
      ...
      <p className="font-['Red_Hat_Display:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#151515] text-[14px] whitespace-nowrap">Insights</p>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="content-stretch flex font-normal gap-[24px] items-center leading-[normal] relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['Red_Hat_Display:Regular',sans-serif] min-h-px min-w-px relative text-[#151515] text-[14px]">Resource</p>
...
function Frame115() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] text-[14px] w-full">CPU</p>
...
function Frame117() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] text-[14px] w-full">Memory</p>
...
function Frame119() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold relative shrink-0 text-[#151515] text-[14px] w-full">Filesystem</p>
...
function Frame121() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#151515] text-[14px] w-full">Network transfer</p>
    </div>
  );
}
...
function MainNavToggle() {
  return (
    <div className="content-stretch flex h-[40px] items-center justify-center relative shrink-0 w-[48px]" data-name="Main Nav Toggle">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="rh-ui-icon-menu-bars">
        <div className="absolute inset-[15.63%_3.13%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 11">
            <path d={svgPaths.p155a1a00} fill="var(--fill-0, #1F1F1F)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
export default function Home() {
  return (
    <div className="bg-[#f2f2f2] overflow-clip relative rounded-[32px] size-full" data-name="Home">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[1080px] left-1/2 top-1/2 w-[1920px]" data-name="Frosted Surface">
        <div className="absolute backdrop-blur-[96px] bg-[rgba(0,0,0,0.01)] inset-0" data-name="Frosted Surface" />
      </div>
      <div className="absolute content-stretch flex gap-[24px] items-center p-[24px] right-0 top-0" data-name="Utility">
        <Frame30 />
        <AvatarMd />
      </div>
      <Heading />
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[152px] w-[292px]" data-name="Menu Item">
        <Content />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[196px] w-[292px]" data-name="Menu Item">
        <Content1 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[240px] w-[292px]" data-name="Menu Item">
        <Content2 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[284px] w-[292px]" data-name="Menu Item">
        <Content3 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[328px] w-[292px]" data-name="Menu Item">
        <Content4 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[372px] w-[292px]" data-name="Menu Item">
        <Content5 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[416px] w-[292px]" data-name="Menu Item">
        <Content6 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[460px] w-[292px]" data-name="Menu Item Observe">
        <Content7 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[504px] w-[292px]" data-name="Menu Item">
        <Content8 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[548px] w-[292px]" data-name="Menu Item">
        <Content9 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[24px] px-[16px] rounded-[24px] top-[592px] w-[292px]" data-name="Menu Item">
        <Content10 />
        <div className="overflow-clip relative shrink-0 size-[12px]" data-name="rh-micron-caret-right">
          <div className="absolute bottom-[5%] left-1/4 right-[26.04%] top-[5%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.87538 10.8001">
      ...
      <div className="absolute h-[968px] left-[calc(16.67%+20px)] top-[88px] w-[1556px]" data-name="Home Content">
        <Frame />
        <Frame71 />
        <Frame52 />
        <Frame104 />
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex gap-[16px] items-center left-[calc(4.17%+35px)] p-[24px] top-[calc(50%-496px)]" data-name="Branding">
        <MainNavToggle />
