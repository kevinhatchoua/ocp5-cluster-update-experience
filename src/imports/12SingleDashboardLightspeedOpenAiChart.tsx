import svgPaths from "./svg-al6typaggi";
import img12SingleDashboardLightspeedOpenAiChart from "figma:asset/0063c8b2c924b83b2301cb4476c9f3da3f438e88.png";
...
import { imgGroup } from "./svg-9p0va";
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <div className="relative shrink-0 size-[18px]" data-name="IconWrapper">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-6.58px)] size-[12px] top-[calc(50%-5.25px)]" data-name="🖼️ Icon">
    ...
    <div className="h-[16px] relative shrink-0 w-full" data-name="Heading">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          ...
          <div className="flex items-center justify-center relative shrink-0 size-[12px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18" } as React.CSSProperties}>
...
export default function Component12SingleDashboardLightspeedOpenAiChart() {
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="12 - Single Dashboard - Lightspeed Open - AI Chart">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[32px] size-full" src={img12SingleDashboardLightspeedOpenAiChart} />
      <Chatbot />
