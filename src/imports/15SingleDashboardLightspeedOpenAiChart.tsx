import svgPaths from "./svg-c08xtuzfo4";
import img15SingleDashboardLightspeedOpenAiChart from "figma:asset/36e6362e0985ed0b78c1c2e915d3ed8df2963824.png";
import { imgGroup } from "./svg-d8ebm";
...
function Content() {
  return (
    <div className="h-[244px] relative shrink-0 w-full" data-name="Content">
...
function AiMessage1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="AI Message">
      <div className="h-[105px] relative shrink-0 w-[402px]" data-name="I’ve generated the P...">
        <div className="absolute font-['Red_Hat_Text:Regular',sans-serif] font-normal leading-[21px] left-0 text-[#151515] text-[14px] top-0 w-[402px] whitespace-pre-wrap">
          <p className="mb-0">I’ve generated the Project Resource Overview for you.</p>
          <p className="mb-0">&nbsp;</p>
          <p>{`Most pods are idling at < 0.1 cores, but I noticed the api-gateway pod spiked to 0.75 cores about 20 minutes ago. Everything has since returned to baseline.`}</p>
        </div>
      </div>
    </div>
  );
...
function Messages() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Messages">
      ...
      <div className="backdrop-blur-[0px] bg-white content-stretch flex flex-col items-center relative rounded-[16px] shrink-0 w-[402px]" data-name="Widget Card PF">
      ...
      <div className="col-1 h-[269px] ml-0 mt-0 relative row-1 w-[573px]" data-name="Line chart line sets">
        ...
        <div className="absolute inset-[43.17%_0_21.86%_0]" data-name="Line Chart Individual Lines">
          <div className="absolute inset-[1.56%_0_2.34%_0]">
            <div className="absolute inset-[-1.95%_0_-2.06%_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 573.971 92.9348">
                <path d={svgPaths.p2fedfa00} id="Line 3" stroke="var(--stroke-0, #003366)" strokeWidth="2" />
              </svg>
            </div>
          </div>
        </div>
        <div className="absolute inset-[6.56%_0_0_0]" data-name="Line Chart Individual Lines">
          <div className="absolute inset-[1.56%_0_2.34%_0]">
            <div className="absolute inset-[-0.77%_0_-1.01%_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 574.489 245.956">
                <path d={svgPaths.p20d46200} id="Line 3" stroke="var(--stroke-0, #92C5F9)" strokeWidth="2" />
              </svg>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="X axis">
      <div className="h-px relative shrink-0 w-full" data-name="x-axis stroke">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 573 1">
          <path clipRule="evenodd" d="M0 0H573V1H0V0Z" fill="var(--fill-0, #C7C7C7)" fillRule="evenodd" id="x-axis stroke" />
        </svg>
      </div>
      <XAxisValues />
    </div>
...
function WidgetCard() {
  return (
    <div className="bg-[rgba(41,41,41,0.2)] content-stretch flex flex-[1_0_0] flex-col h-[320px] items-start min-h-px min-w-px opacity-0 relative rounded-[24px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.16)]" data-name="Widget Card">
      <Header1 />
      <Content2 />
      <Actions3 />
    </div>
...
function Content1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-full" data-name="Content">
      <div className="content-stretch flex flex-col gap-[48px] items-start pb-[64px] relative size-full">
        <Frame39 />
      </div>
    </div>
  );
...
function DashboardSingleContent() {
  return (
...
function Chart2() {
  return (
    <div className="h-[228.1px] overflow-clip relative shrink-0 w-full" data-name="Chart">
      <Group19 />
      <Group21 />
      <Group22 />
      <Group27 />
...
function AddToNewDashboardAction1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Add to New Dashboard Action">
      <Button15 />
    </div>
      ...
      <div className="h-[40px] overflow-clip relative shrink-0 w-[118px]" data-name="Red Hat OpenShift/Red Hat OpenShift logo - Full color">
        <div className="absolute inset-[59.9%_57.93%_9.21%_31.48%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.494 12.3569">
            <path d={svgPaths.p3149000} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[68.2%_49.06%_0.82%_43.51%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.7702 12.392">
            <path d={svgPaths.p37667600} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[68.2%_40.71%_9.29%_52.02%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.5808 9.003">
            <path d={svgPaths.p3cfc2e80} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[68.11%_32.77%_9.68%_60.67%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.74413 8.8842">
            <path d={svgPaths.p1e248880} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[59.97%_23.44%_9.27%_68.16%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.91486 12.3026">
            <path d={svgPaths.p156d0f00} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[59.43%_15.64%_9.68%_77.8%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.74249 12.3569">
            <path d={svgPaths.p1486fc00} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[59.73%_12.38%_9.68%_85.87%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.06637 12.2368">
            <path d={svgPaths.p24ec5f00} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[58.23%_6.15%_9.68%_88.58%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.21902 12.8363">
            <path d={svgPaths.p1e268b00} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[61.95%_0.33%_9.31%_94.49%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.11361 11.4946">
            <path d={svgPaths.p7d1a200} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
        ...
        <div className="absolute inset-[13.96%_14.32%_53.8%_31.75%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63.6313 12.8934">
            <path d={svgPaths.pd33a670} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
    ...
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      ...
      <div className="bg-white content-stretch flex gap-[4px] h-[37px] items-center justify-center min-w-[40px] p-[8px] relative rounded-[6px] shrink-0 w-[60px]" data-name="Overflow menu">
        ...
        <div className="h-[21px] relative shrink-0 w-[16px]" data-name="IconWrapper">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+1.17px)] size-[14px] top-[calc(50%+0.5px)]" data-name="🖼️ Icon">
...
function AvatarMd() {
  return (
    <div className="bg-[#b9dafc] content-stretch flex items-center justify-center p-[4px] relative rounded-[999px] shrink-0 size-[36px]" data-name="avatar-MD">
      <p className="font-['Red_Hat_Display:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">JS</p>
    </div>
  );
}
...
export default function Component15SingleDashboardLightspeedOpenAiChart() {
  return (
    <div className="overflow-clip relative rounded-[32px] size-full" data-name="15 - Single Dashboard - Lightspeed Open - AI Chart">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[32px] size-full" src={img15SingleDashboardLightspeedOpenAiChart} />
      <Chatbot />
      <DashboardSingleContent />
      <div className="absolute backdrop-blur-[0px] bg-white content-stretch flex flex-col items-center left-[calc(16.67%+52px)] opacity-50 rounded-[16px] top-[342px] w-[497px]" data-name="Widget Card PF">
        <div aria-hidden="true" className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_6px_0px_rgba(41,41,41,0.15)]" />
        <Header2 />
        <Content3 />
        <Actions5 />
